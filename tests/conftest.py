...
# WARNING: Ensure imports from `api_beegol_insights` comes after this line
from api_beegol_insights import app, settings, db  # noqa
from api_beegol_insights.cli import create_user, cli  # noqa
